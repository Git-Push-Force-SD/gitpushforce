...
// ── Main flow component ───────────────────────
const BookingFlowTrades = ({ eligibleTrades, onConfirm, submitting }) => {
  const [step,        setStep]        = useState(1);
  const [selectedTrade, setSelectedTrade] = useState(eligibleTrades[0] || null);
    ...
    <div>
      ...
      <div className="mb-4">
        ...
        <select
          ...
          onChange={e => {
            const trade = eligibleTrades.find(t => t.tradeId === e.target.value);
...
export default BookingFlowTrades;