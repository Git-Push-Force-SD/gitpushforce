      ...
      <section className="max-w-3xl mx-auto mt-12 px-6">
        ...
        <section className="flex flex-col md:flex-row items-center gap-8 mb-16">
          <section className="relative">
            ...
            />
            <button className="absolute -bottom-2 -right-2 w-8 h-8 bg-primary text-white rounded-full flex items-center justify-center shadow-md hover:bg-dark transition-colors border-2 border-white">
              <Edit2 size={14} />
            </button>
          </section>
          ...
          <section className="text-center md:text-left">
             ...
             <section className="flex flex-wrap justify-center md:justify-start gap-2">
               <span className="px-3 py-1 bg-gray-100 text-gray-500 rounded text-[0.65rem] font-bold tracking-wider uppercase">Class of 2025</span>
               <span className="px-3 py-1 bg-gray-100 text-gray-500 rounded text-[0.65rem] font-bold tracking-wider uppercase">Premium Curator</span>
             </section>
          </section>
        </section>
        ...
        <section>
          ...
          <section className="space-y-4">
             {activeListings.map(listing => (
               <section key={listing.id} className="bg-white p-4 rounded-xl flex items-center shadow-[0_2px_10px_rgba(0,0,0,0.03)] border border-gray-50 gap-5 relative group">
