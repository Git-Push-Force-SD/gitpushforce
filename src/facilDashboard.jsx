      ...
      <section className="grid min-h-screen lg:grid-cols-[260px_1fr]">
        <aside className="border-r border-black/5 bg-white/70 backdrop-blur-xl">
          <section className="flex h-full flex-col p-6">
            ...
            <section className="mt-auto rounded-[28px] bg-dark p-5 text-white shadow-2xl">
              <section className="flex items-center gap-3">
                <section className="flex h-11 w-11 items-center justify-center rounded-2xl bg-primary/20">
        ...
        <section className="p-4 md:p-8">
          <section className="mx-auto max-w-7xl space-y-8">
            <header className="rounded-[32px] bg-dark text-white shadow-xl">
              <section className="grid gap-8 p-6 md:grid-cols-[1.3fr_0.9fr] md:p-8">
                <section>
                  <section className="flex items-center gap-3 text-sm text-white/70">
                ...
                <section className="grid gap-4 sm:grid-cols-2">
                  {stats.map((stat) => {
                    ...
                    return (
                      <section key={stat.label} className="rounded-[24px] border border-white/10 bg-white/5 p-5 backdrop-blur">
                ...
                <section className="rounded-[30px] bg-white p-6 shadow-sm ring-1 ring-black/5 md:p-7">
                  <section className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                    ...
                    <section className="flex flex-col gap-3 sm:flex-row">
                      <section className="flex items-center gap-2 rounded-full border border-light bg-light px-4 py-3">
                      ...
                      <section className="flex items-center gap-2 rounded-full border border-light bg-white px-4 py-3">
                  ...
                  <section className="mt-6 overflow-hidden rounded-[24px] border border-light">
                    <section className="grid grid-cols-[1.1fr_0.9fr_1fr_0.8fr_0.8fr] gap-4 bg-light px-5 py-4 text-xs font-bold uppercase tracking-[0.2em] text-text-muted">
                      <span>Trade</span>
                    ...
                    <section className="sectionide-y sectionide-light">
                      {filteredTrades.map((trade) => (
                        ...
                        >
                          <section>
                            <section className="flex items-center gap-3">
                              <section className="flex h-11 w-11 items-center justify-center rounded-2xl bg-light">
                  ...
                  <section className="rounded-[30px] bg-white p-6 shadow-sm ring-1 ring-black/5 md:p-7">
                    ...
                    <section className="mt-6 space-y-4">
                      {[
                        ...
                        <section key={zone.zone} className="rounded-[22px] border border-light bg-light p-4">
                  ...
                  <section className="rounded-[30px] bg-white p-6 shadow-sm ring-1 ring-black/5 md:p-7">
                    ...
                    <section className="mt-6 space-y-4">
                      {messages.map((message) => (
                        <section key={`${message.from}-${message.time}`} className="rounded-[22px] border border-light p-4">
                ...
                <section className="rounded-[30px] bg-white p-6 shadow-sm ring-1 ring-black/5 md:p-7">
                  ...
                  <section className="mt-6 space-y-4">
                    {incidents.map((incident) => (
                      <section key={incident.tradeId} className="rounded-[24px] border border-light p-4">
                        <section className="flex items-start justify-between gap-4">
                          <section>
                ...
                <section className="rounded-[30px] bg-dark p-6 text-white shadow-xl md:p-7">
                  ...
                  <section className="mt-6 space-y-3">
                    {[
                      ...
                      return (
                        <section key={step.text} className="flex items-start gap-3 rounded-[20px] border border-white/10 bg-white/5 p-4">
                          <section className="mt-0.5 flex h-9 w-9 items-center justify-center rounded-2xl bg-primary/15">
